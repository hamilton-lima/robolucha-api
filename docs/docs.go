...
// 2019-07-23 07:18:03.3550288 -0400 DST m=+0.187972001
...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/main.MatchMetric"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.Classroom"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/main.ActiveMatch"
                            }
                        }
                    }
                }
        ...
        "/private/start-tutorial-match/{name}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
